...
//le fichier se nomme: image.php attention au chemin, a modifier dans le formulaire si necessaire
...
$code1=substr(str_shuffle($caracteres),0,5); // le dernier chiffre donne le nombre de caractères, attention de rallonger le rectangle en cas d'ajout de nombre en ligne 6
...
for($i=0;$i<=strlen($code1);$i++){
    ...
    //on rajoute des espace entre chaque lettre ou chiffre pour faire plus aéré 
    //(notez le . devant = qui permettra d'ajouter un caractère après l'autre à $code)
}
